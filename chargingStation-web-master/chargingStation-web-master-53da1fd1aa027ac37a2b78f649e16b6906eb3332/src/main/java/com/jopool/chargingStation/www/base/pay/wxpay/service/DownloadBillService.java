...
public class DownloadBillService extends BaseService {
    ...
    public DownloadBillService(WXAbstractConfig wxConfig) throws IllegalAccessException, InstantiationException, ClassNotFoundException {
        super(WXAbstractConfig.DOWNLOAD_BILL_API, wxConfig);
    }
