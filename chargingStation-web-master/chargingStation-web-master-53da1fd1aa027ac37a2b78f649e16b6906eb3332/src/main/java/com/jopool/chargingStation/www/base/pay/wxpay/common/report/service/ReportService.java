package com.jopool.chargingStation.www.base.pay.wxpay.common.report.service;

import com.jopool.chargingStation.www.base.pay.wxpay.common.HttpsRequest;
...
public class ReportService {
    ...
    public String request() throws UnrecoverableKeyException, KeyManagementException, NoSuchAlgorithmException, KeyStoreException, IOException {
        String responseString = new HttpsRequest().sendPost(WXAbstractConfig.REPORT_API, reqData);
    ...
    public static String request(ReportReqData reportReqData) throws Exception {
        ...
        //--------------------------------------------------------------------
        String responseString = new HttpsRequest().sendPost(WXAbstractConfig.REPORT_API, reportReqData);
