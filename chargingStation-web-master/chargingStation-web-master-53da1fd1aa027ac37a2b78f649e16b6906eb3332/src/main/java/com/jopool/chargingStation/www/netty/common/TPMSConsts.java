package com.jopool.chargingStation.www.netty.common;
...
public class TPMSConsts {
    ...
    // 终端心跳
    public static final String MSG_TYPE_TERMINAL_HEART_BEAT               = "V1";
    public static final String MSG_TYPE_TERMINAL_LOCATION_INFO_UPLOAD     = "V2";
    // 终端注册
