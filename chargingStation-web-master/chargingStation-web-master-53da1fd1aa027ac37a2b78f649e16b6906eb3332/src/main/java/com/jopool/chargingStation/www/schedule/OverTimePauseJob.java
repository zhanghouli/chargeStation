 ...
 */
public class OverTimePauseJob implements Job {
    private static Logger logger = LoggerFactory.getLogger(OverTimePauseJob.class);
    ...
    public void execute(JobExecutionContext context) throws JobExecutionException {
        ...
        orderService.stopRecharge(dataMap.get("stationId"), Integer.parseInt(dataMap.get("cn")), ReportTypeEnum.CLOSE_WAIT_TIMEOUT.getValue());
    }
}
