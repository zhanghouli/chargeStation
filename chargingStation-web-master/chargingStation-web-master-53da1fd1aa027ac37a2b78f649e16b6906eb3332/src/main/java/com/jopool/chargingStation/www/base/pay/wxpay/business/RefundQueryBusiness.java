...
import com.jopool.chargingStation.www.base.pay.wxpay.common.XMLParser;
...
import com.jopool.chargingStation.www.base.pay.wxpay.protocol.refund_query_protocol.RefundOrderData;
import com.jopool.chargingStation.www.base.pay.wxpay.protocol.refund_query_protocol.RefundQueryReqData;
import com.jopool.chargingStation.www.base.pay.wxpay.protocol.refund_query_protocol.RefundQueryResData;
import com.jopool.chargingStation.www.base.pay.wxpay.service.RefundQueryService;
...
public class RefundQueryBusiness extends BaseBusiness  {
    ...
    public RefundQueryBusiness(WXAbstractConfig wxConfig) throws IllegalAccessException, ClassNotFoundException, InstantiationException {
        this.wxConfig = wxConfig;
        refundQueryService = new RefundQueryService(wxConfig);
    }
    ...
    public void run(RefundQueryReqData refundQueryReqData, ResultListener resultListener) throws Exception {
        ...
        ReportReqData reportReqData = new ReportReqData(wxConfig,
                ...
                WXAbstractConfig.REFUND_QUERY_API,
        ...
        if (refundQueryResData.getReturn_code().equals("FAIL")) {
            ...
            if (!Signature.checkIsSignValidFromResponseString(wxConfig, refundQueryServiceResponseString)) {
