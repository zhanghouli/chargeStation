package com.jopool.chargingStation.www.base.pay.wxpay.common.report.protocol;

import com.jopool.chargingStation.www.base.pay.wxpay.common.RandomStringGenerator;
...
public class ReportReqData {
     ...
     */
    public ReportReqData(WXAbstractConfig wxConfig, String deviceInfo, String interfaceUrl, int executeTimeCost, String returnCode, String returnMsg, String resultCode, String errCode, String errCodeDes, String outTradeNo, String userIp) {
        ...
        setMch_id(wxConfig.getMchId());
        setSub_mch_id(wxConfig.getSubmchId());
