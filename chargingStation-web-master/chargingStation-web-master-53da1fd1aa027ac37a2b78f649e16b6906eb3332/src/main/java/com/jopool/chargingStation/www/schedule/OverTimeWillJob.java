 ...
 * 没有硬件支持  订单自动取消
 */
public class OverTimeWillJob implements Job {
    private static Logger logger = LoggerFactory.getLogger(OverTimeWillJob.class);
    ...
    public void execute(JobExecutionContext context) throws JobExecutionException {
        ...
        orderService.overTimeOutWill(dataMap.get("number"));
    }
}
