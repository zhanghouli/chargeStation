...
import com.jopool.chargingStation.www.base.pay.wxpay.protocol.refund_protocol.RefundResData;
import com.jopool.chargingStation.www.base.pay.wxpay.service.RefundService;
...
public class RefundBusiness extends BaseBusiness {
    ...
    public RefundBusiness(WXAbstractConfig wxConfig) throws IllegalAccessException, ClassNotFoundException, InstantiationException {
        this.wxConfig = wxConfig;
        refundService = new RefundService(wxConfig);
    }
    ...
    public void run(RefundReqData refundReqData, ResultListener resultListener) throws Exception {
        ...
        if (refundResData.getReturn_code().equals("FAIL")) {
            ...
            if (!Signature.checkIsSignValidFromResponseString(wxConfig, refundServiceResponseString)) {
