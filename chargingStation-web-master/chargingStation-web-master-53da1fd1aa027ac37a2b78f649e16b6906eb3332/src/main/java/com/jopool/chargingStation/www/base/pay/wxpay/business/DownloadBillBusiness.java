...
import com.jopool.chargingStation.www.base.pay.wxpay.protocol.downloadbill_protocol.DownloadBillResData;
import com.jopool.chargingStation.www.base.pay.wxpay.service.DownloadBillService;
 ...
 * Time: 10:45
 */
public class DownloadBillBusiness extends BaseBusiness {

    public DownloadBillBusiness(WXAbstractConfig wxConfig) throws IllegalAccessException, ClassNotFoundException, InstantiationException {
        this.wxConfig = wxConfig;
        downloadBillService = new DownloadBillService(wxConfig);
    }
    ...
    public void run(DownloadBillReqData downloadBillReqData, ResultListener resultListener) throws Exception {
        ...
        try {
            ...
            ReportReqData reportReqData = new ReportReqData(wxConfig,
                    ...
                    WXAbstractConfig.DOWNLOAD_BILL_API,
