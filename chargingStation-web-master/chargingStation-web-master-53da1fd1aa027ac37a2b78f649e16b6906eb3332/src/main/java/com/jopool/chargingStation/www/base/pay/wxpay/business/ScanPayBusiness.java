...
import com.jopool.chargingStation.www.base.pay.wxpay.common.Log;
...
import com.jopool.chargingStation.www.base.pay.wxpay.common.report.ReporterFactory;
import com.jopool.chargingStation.www.base.pay.wxpay.common.report.protocol.ReportReqData;
import com.jopool.chargingStation.www.base.pay.wxpay.common.report.service.ReportService;
...
import com.jopool.chargingStation.www.base.pay.wxpay.protocol.pay_protocol.ScanPayResData;
import com.jopool.chargingStation.www.base.pay.wxpay.protocol.pay_query_protocol.ScanPayQueryReqData;
import com.jopool.chargingStation.www.base.pay.wxpay.protocol.pay_query_protocol.ScanPayQueryResData;
import com.jopool.chargingStation.www.base.pay.wxpay.protocol.reverse_protocol.ReverseReqData;
import com.jopool.chargingStation.www.base.pay.wxpay.protocol.reverse_protocol.ReverseResData;
import com.jopool.chargingStation.www.base.pay.wxpay.service.ReverseService;
import com.jopool.chargingStation.www.base.pay.wxpay.service.ScanPayQueryService;
import com.jopool.chargingStation.www.base.pay.wxpay.service.ScanPayService;
 ...
 * Time: 17:05
 */
public class ScanPayBusiness extends BaseBusiness {

    public ScanPayBusiness(WXAbstractConfig wxConfig) throws IllegalAccessException, ClassNotFoundException, InstantiationException {
        this.wxConfig = wxConfig;
        scanPayService = new ScanPayService(wxConfig);
        scanPayQueryService = new ScanPayQueryService(wxConfig);
        reverseService = new ReverseService(wxConfig);
    }
    ...
    public void run(ScanPayReqData scanPayReqData, ResultListener resultListener) throws Exception {
        ...
        ReportReqData reportReqData = new ReportReqData(wxConfig,
                scanPayReqData.getDevice_info(),
                WXAbstractConfig.PAY_API,
        ...
        if (wxConfig.isUsethreadtodoreport()) {
        ...
        if (scanPayResData.getReturn_code().equals("FAIL")) {
            ...
            //--------------------------------------------------------------------
            if (!Signature.checkIsSignValidFromResponseString(wxConfig, payServiceResponseString)) {
    ...
    private boolean doOnePayQuery(String outTradeNo) throws Exception {
        ...
        ScanPayQueryReqData scanPayQueryReqData = new ScanPayQueryReqData(wxConfig, "", outTradeNo);
    ...
    private boolean doOneReverse(String outTradeNo) throws Exception {
        ...
        ReverseReqData reverseReqData = new ReverseReqData(wxConfig, "", outTradeNo);
