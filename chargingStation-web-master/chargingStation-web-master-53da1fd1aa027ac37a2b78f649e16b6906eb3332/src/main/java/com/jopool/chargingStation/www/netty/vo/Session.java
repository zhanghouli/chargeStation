...
public class Session {
	...
	public static Session buildSession(Channel channel, String deviceNumber) {
		Session session = new Session();
		session.setChannel(channel);
		session.setId(buildId(channel));
		session.setDeviceNumber(deviceNumber);
	...
	public String toString() {
		return "Session [id=" + id + ", deviceNumber=" + deviceNumber + ", channel=" + channel + "]";
	}
