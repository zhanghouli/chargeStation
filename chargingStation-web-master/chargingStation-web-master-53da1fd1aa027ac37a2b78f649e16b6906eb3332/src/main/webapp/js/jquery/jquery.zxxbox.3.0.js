...
(function ($) {
    ...
    var LG = 'linear-gradient(top, #fafafa, #eee)', CSS = '<style type="text/css">' +
        ...
        '.wrap_out{background:#eee;box-shadow:1px 8px 10px 1px #9b9b9b;position:absolute;z-index:2000;left:-9999px;background: #fcfdfd;border-radius: 1px;}' +
        '.wrap_in{background:#fafafa;}' +
        '.wrap_bar{height:40px; line-height:40px; background:#467099; cursor:pointer;}' +
        ...
        '.submit_btn{}' +
        '.submit_btn:hover{background: #365675;text-decoration:none;color:#fff;}' +
