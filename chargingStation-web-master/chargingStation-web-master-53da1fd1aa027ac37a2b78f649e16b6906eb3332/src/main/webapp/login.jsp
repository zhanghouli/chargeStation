...
<div class="loginbody">
    <span class="systemlogo">智能充电站</span>

    <form name="loginForm" id="loginForm" action="doLogin.htm" method="post">
        <div class="loginbox">
            <ul>
                <li><input name="userName" type="text" class="loginuser validate[required]" placeholder="用户名"/></li>
...
<div class="loginbm">© 2016-2017 好驿达充电 版权所有</div>
</body>
</html>
